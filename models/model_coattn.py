...
class MCAT_Surv(nn.Module):
    def __init__(self, fusion='concat', omic_sizes=[100, 200, 300, 400, 500, 600], n_classes=4,
                 model_size_wsi: str='small', model_size_omic: str='small', dropout=0.25, wsi_dim=1024):
        super(MCAT_Surv, self).__init__()
        self.fusion = fusion
        self.omic_sizes = omic_sizes
        self.n_classes = n_classes
        # Support configurable WSI input dimension (768 for TITAN, 1024 for CLAM)
    ...
    def forward(self, **kwargs):
        x_path = kwargs['x_path'] # (num_patch, wsi_dim)
        # Support dynamic number of omic inputs
